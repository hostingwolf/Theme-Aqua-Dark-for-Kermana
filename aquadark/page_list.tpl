...
<div class="panel panel-default panel-aquadark">
    <div class="panel-heading panel-head-aqua"><h1 style="margin:0">{$cat_name}</h1></div>
...
<!-- ENDIF -->
	...
	<tr>
		<th width="15%"></th>
		<th class="link-list" width="70%"><a href="javascript:sortby('t')">{$l_title}</a></th>
		<th class="link-list" style="text-align:right" width="15%"><a href="javascript:sortby('d')">{$l_date}</a></th>
	</tr>
	<!-- BEGINBLOCK list -->
	<tr>
