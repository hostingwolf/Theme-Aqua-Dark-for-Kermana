...
<div class="panel panel-default panel-aquadark">
    <div class="panel-heading panel-head-aqua"><span class="glyphicon glyphicon-king" aria-hidden="true"></span> {$l_my_listing}</div>
...
<div class="panel panel-default panel-aquadark">
    <div class="panel-heading panel-head-aqua"><span class="glyphicon glyphicon-king" aria-hidden="true"></span> {$l_my_order}</div>
    <table border="0" width="100%" class="table table-form">
...
<div class="panel panel-default panel-aquadark">
    <div class="panel-heading panel-head-aqua"><span class="glyphicon glyphicon-th" aria-hidden="true"></span> {$l_my_order}</div>
    <table border="0" width="100%" class="table table-form">
