...
<div id="welcome" class="container">
    <form method="get" action="listing_search.php">
        ...
        <button type="submit" class="btn btn-primary bt-search">{$l_search}</button>
    </form>
    ...
    <h1 class="h1-featured">{$l_featured_listing}</h1>
    <div class="row" id="welcome_feat">
        ...
        display = grid
        div_id = welcome_feat
        csswrapper_grid = col-xs-12 col-sm-4 col-md-3 col-lg-3
